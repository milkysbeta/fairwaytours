...
export const HERO_SEQUENCE: HeroSegment[] = [
  ...
  {
    id: 'course',
    src: '/media/hero/02-course.mp4',
    line: 'Someone is already waiting.',
    hold: 4.5,
  },
  {
    id: 'play',
    src: '/media/hero/03-play.mp4',
    line: 'You play courses others cannot.',
    hold: 4.5,
  },
  {
    id: 'table',
    src: '/media/hero/04-table.mp4',
    line: 'Nothing else needs your attention.',
    hold: 5,
  },
]
